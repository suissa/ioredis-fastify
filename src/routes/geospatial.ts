...
interface IGeoRadiusQuery { lon: number; lat: number; radius: number; unit: 'm' | 'km' | 'ft' | 'mi'; withdist?: boolean; withcoord?: boolean; count?: number; }
